...
Detailed description of running this web-application through virtual machine using gunicorn is <strong><a href="https://github.com/MathewShuvarikov/pabd24/blob/main/src/predict_app.py">here</a>
